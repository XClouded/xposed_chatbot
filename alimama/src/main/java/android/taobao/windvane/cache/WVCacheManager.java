...
public class WVCacheManager {
    ...
    public boolean isCacheEnabled(String str) {
        ...
        if (parse == null || !parse.isHierarchical() || !TextUtils.isEmpty(parse.getQueryParameter(WVConstants.LOCAL_CACHE_TAG)) || !"0".equals(parse.getQueryParameter(WVConstants.LOCAL_CACHE_TAG))) {
            return true;
        }
        return false;
    }
