...
public class WVBluetooth extends WVApiPlugin {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        public void onConnectionStateChange(BluetoothGatt bluetoothGatt, int i, int i2) {
            int unused = WVBluetooth.this.mCurrentConnectionState = i2;
            ...
            if (WVBluetooth.this.mConnectCallback != null) {
                ...
                WVCallBackContext unused2 = WVBluetooth.this.mConnectCallback = null;
            }
        ...
        public void onServicesDiscovered(BluetoothGatt bluetoothGatt, int i) {
            ...
            if (WVBluetooth.this.mGetServiceCallback != null) {
                ...
                for (BluetoothGattService uuid : bluetoothGatt.getServices()) {
                    try {
                        jSONArray.put(new JSONObject().put("serviceId", uuid.getUuid()));
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
                ...
                WVCallBackContext unused = WVBluetooth.this.mGetServiceCallback = null;
            }
        }
        ...
        public void onCharacteristicRead(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic, int i) {
            ...
            if (WVBluetooth.this.mReadValueCallback != null) {
                ...
                WVCallBackContext unused = WVBluetooth.this.mReadValueCallback = null;
            }
        }
        ...
        public void onCharacteristicWrite(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic, int i) {
            ...
            WVCallBackContext unused = WVBluetooth.this.mWriteValueCallback = null;
        }
    ...
    /* access modifiers changed from: private */
    public WVCallBackContext mGetServiceCallback = null;
    /* access modifiers changed from: private */
    ...
    public void requestAuthorization(String str, final WVCallBackContext wVCallBackContext) {
        try {
            PermissionProposer.buildPermissionTask(this.mContext, new String[]{"android.permission.BLUETOOTH", "android.permission.BLUETOOTH_ADMIN", "android.permission.ACCESS_FINE_LOCATION"}).setTaskOnPermissionGranted(new Runnable() {
                public void run() {
                    WVResult wVResult = new WVResult();
                    JSONObject jSONObject = new JSONObject();
                    ...
                    } else if (WVBluetooth.this.mBTAdapter.isEnabled() || WVBluetooth.this.mBTAdapter.enable()) {
                        try {
    ...
    public void getServices(String str, WVCallBackContext wVCallBackContext) {
        ...
        if (this.mBTAdapter == null) {
            ...
            try {
                ...
                wVResult.addData("msg", (Object) th.getCause());
                wVCallBackContext.error(wVResult);
            }
    ...
    public void getCharacteristics(String str, WVCallBackContext wVCallBackContext) {
        ...
        if (this.mBTAdapter.isEnabled()) {
            try {
                ...
                if (this.mBluetoothGatt != null) {
                    if (optString.equals(this.mBluetoothGatt.getDevice().getAddress())) {
                        ...
                        for (BluetoothGattCharacteristic uuid : service.getCharacteristics()) {
                            jSONArray.put(new JSONObject().put("characteristicId", uuid.getUuid()));
                        }
