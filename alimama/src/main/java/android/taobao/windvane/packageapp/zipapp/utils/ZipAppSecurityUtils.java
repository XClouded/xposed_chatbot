...
public class ZipAppSecurityUtils {
    ...
    public static boolean validConfigFile(String str, String str2) {
        try {
            return RsaUtil.decryptData(str2, (Key) RsaUtil.getPublicKey("")).equals(DigestUtils.md5ToHex(str));
        } catch (Exception e) {
