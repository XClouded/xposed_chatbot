...
public final class AppCompatDrawableManager {
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(@androidx.annotation.NonNull android.content.Context r10, @androidx.annotation.DrawableRes int r11) {
        ...
        L_0x0077:
            ...
            androidx.collection.ArrayMap<java.lang.String, androidx.appcompat.widget.AppCompatDrawableManager$InflateDelegate> r7 = r9.mDelegates     // Catch:{ Exception -> 0x00a8 }
            java.lang.Object r2 = r7.get(r2)     // Catch:{ Exception -> 0x00a8 }
            androidx.appcompat.widget.AppCompatDrawableManager$InflateDelegate r2 = (androidx.appcompat.widget.AppCompatDrawableManager.InflateDelegate) r2     // Catch:{ Exception -> 0x00a8 }
