...
public class LinearSystem {
    ...
    public void displaySystemInformations() {
        ...
        printStream.println("Linear System -> Table size: " + this.TABLE_SIZE + " (" + getDisplaySize(this.TABLE_SIZE * this.TABLE_SIZE) + ") -- row sizes: " + getDisplaySize(i) + ", actual size: " + getDisplaySize(i3) + " rows: " + this.mNumRows + "/" + this.mMaxRows + " cols: " + this.mNumColumns + "/" + this.mMaxColumns + Operators.SPACE_STR + 0 + " occupied cells, " + getDisplaySize(0));
    }
