    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 18) {
                SERVICES.put(BluetoothManager.class, IWXConnection.TYPE_BLUETOOTH);
            }
            if (Build.VERSION.SDK_INT >= 17) {
                SERVICES.put(DisplayManager.class, "display");
                SERVICES.put(UserManager.class, UNWLogger.LOG_VALUE_TYPE_USER);
            }
            if (Build.VERSION.SDK_INT >= 16) {
            ...
            SERVICES.put(AccountManager.class, LoginConstant.ACCOUNT);
            ...
            SERVICES.put(StorageManager.class, Config.TYPE_STORAGE);
