...
public final class RectKt {
    ...
    public static final Rect plus(@NotNull Rect rect, @NotNull Rect rect2) {
        Intrinsics.checkParameterIsNotNull(rect, "$receiver");
        Intrinsics.checkParameterIsNotNull(rect2, UploadQueueMgr.MSGTYPE_REALTIME);
    ...
    public static final RectF plus(@NotNull RectF rectF, @NotNull RectF rectF2) {
        Intrinsics.checkParameterIsNotNull(rectF, "$receiver");
        Intrinsics.checkParameterIsNotNull(rectF2, UploadQueueMgr.MSGTYPE_REALTIME);
    ...
    public static final RectF transform(@NotNull RectF rectF, @NotNull Matrix matrix) {
        Intrinsics.checkParameterIsNotNull(rectF, "$receiver");
        Intrinsics.checkParameterIsNotNull(matrix, WXComponent.PROP_FS_MATCH_PARENT);
