...
public final class TransitionKt {
    @RequiresApi(19)
    @NotNull
    public static /* bridge */ /* synthetic */ Transition.TransitionListener addListener$default(Transition transition, Function1 function1, Function1 function12, Function1 function13, Function1 function14, Function1 function15, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        Intrinsics.checkParameterIsNotNull(function16, UmbrellaConstants.LIFECYCLE_START);
        Intrinsics.checkParameterIsNotNull(function17, "onCancel");
        Intrinsics.checkParameterIsNotNull(function14, UmbrellaConstants.LIFECYCLE_RESUME);
        Intrinsics.checkParameterIsNotNull(function15, MessageID.onPause);
    ...
    public static final Transition.TransitionListener addListener(@NotNull Transition transition, @NotNull Function1<? super Transition, Unit> function1, @NotNull Function1<? super Transition, Unit> function12, @NotNull Function1<? super Transition, Unit> function13, @NotNull Function1<? super Transition, Unit> function14, @NotNull Function1<? super Transition, Unit> function15) {
        Intrinsics.checkParameterIsNotNull(transition, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "onEnd");
        Intrinsics.checkParameterIsNotNull(function12, UmbrellaConstants.LIFECYCLE_START);
