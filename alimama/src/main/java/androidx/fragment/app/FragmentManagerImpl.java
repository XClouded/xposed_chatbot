...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public AnimationOrAnimator loadAnimation(Fragment fragment, int i, boolean z, int i2) {
        ...
        if (nextAnim != 0) {
            boolean equals = RouterConstant.ANIM.equals(this.mHost.getContext().getResources().getResourceTypeName(nextAnim));
            boolean z2 = false;
            if (equals) {
                try {
    ...
    public void moveFragmentToExpectedState(androidx.fragment.app.Fragment r11) {
        ...
        L_0x0061:
            ...
            androidx.fragment.app.FragmentManagerImpl$AnimationOrAnimator r0 = r10.loadAnimation(r11, r0, r3, r1)
            if (r0 == 0) goto L_0x0090
