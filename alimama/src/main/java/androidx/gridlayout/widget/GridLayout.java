...
public class GridLayout extends ViewGroup {
    ...
    final class Axis {
        ...
        private String arcsToString(List<Arc> list) {
            StringBuilder sb;
            String str = this.horizontal ? Constants.Name.X : Constants.Name.Y;
        ...
        private boolean solve(Arc[] arcArr, int[] iArr, boolean z) {
            String str = this.horizontal ? Constants.Value.HORIZONTAL : "vertical";
            int count = getCount() + 1;
            boolean[] zArr = null;
            for (int i = 0; i < arcArr.length; i++) {
                init(iArr);
    ...
    static final class Interval {
        ...
        public String toString() {
            return Operators.ARRAY_START_STR + this.min + AVFSCacheConstants.COMMA_SEP + this.max + Operators.ARRAY_END_STR;
        }
    }
    ...
    private static Alignment createSwitchingAlignment(final Alignment alignment, final Alignment alignment2) {
        return new Alignment() {
            ...
            /* access modifiers changed from: package-private */
            public String getDebugString() {
                return "SWITCHING[L:" + alignment.getDebugString() + ", R:" + alignment2.getDebugString() + Operators.ARRAY_END_STR;
            }
        };
    }
}
