...
final class GridModel<K> {
    ...
    private void notifySelectionChanged() {
        for (SelectionObserver onSelectionChanged : this.mOnSelectionChangedListeners) {
            onSelectionChanged.onSelectionChanged(this.mSelection);
        }
    }
    ...
    private static class Limits implements Comparable<Limits> {
        ...
        public String toString() {
            return Operators.BRACKET_START_STR + this.lowerLimit + AVFSCacheConstants.COMMA_SEP + this.upperLimit + Operators.BRACKET_END_STR;
        }
    }
    ...
    static abstract class GridHost<K> extends BandSelectionHelper.BandHost<K> {
        /* access modifiers changed from: package-private */
        public abstract Point createAbsolutePoint(@NonNull Point point);
