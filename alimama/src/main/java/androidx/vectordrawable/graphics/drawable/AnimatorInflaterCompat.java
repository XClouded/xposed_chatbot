    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        if (objArr != null && objArr.length != 0) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                sb.append(i);
                sb.append(": fraction ");
                sb.append(keyframe.getFraction() < 0.0f ? BuildConfig.buildJavascriptFrameworkVersion : Float.valueOf(keyframe.getFraction()));
                sb.append(AVFSCacheConstants.COMMA_SEP);
                sb.append(", value : ");
                sb.append(keyframe.hasValue() ? keyframe.getValue() : BuildConfig.buildJavascriptFrameworkVersion);
