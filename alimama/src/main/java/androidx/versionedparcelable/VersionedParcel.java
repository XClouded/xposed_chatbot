...
public abstract class VersionedParcel {
    ...
    private Method getReadMethod(String str) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        Method declaredMethod = Class.forName(str, true, VersionedParcel.class.getClassLoader()).getDeclaredMethod(MonitorCacheEvent.OPERATION_READ, new Class[]{VersionedParcel.class});
    ...
    private Method getWriteMethod(Class cls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        System.currentTimeMillis();
        Method declaredMethod = findParcelClass.getDeclaredMethod(MonitorCacheEvent.OPERATION_WRITE, new Class[]{cls, VersionedParcel.class});
