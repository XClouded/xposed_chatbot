...
public class DefaultAppMonitor implements IAppMonitor {
            ...
            if (monitor != null) {
                ...
                if (statObject.beforeCommit()) {
                    ...
                    try {
                        ...
                        ALog.e(TAG, "commit monitor point failed", (String) null, th, new Object[0]);
                    }
                }
            }
        }
    ...
    public void commitAlarm(AlarmObject alarmObject) {
        if (mAppMonitorValid && alarmObject != null && !TextUtils.isEmpty(alarmObject.module) && !TextUtils.isEmpty(alarmObject.modulePoint)) {
            if (ALog.isPrintLog(1)) {
                ALog.d(TAG, "commit alarm: " + alarmObject, (String) null, new Object[0]);
            }
    ...
    public void commitCount(CountObject countObject) {
        if (mAppMonitorValid && countObject != null && !TextUtils.isEmpty(countObject.module) && !TextUtils.isEmpty(countObject.modulePoint)) {
            if (ALog.isPrintLog(2)) {
                ALog.i(TAG, "commit count: " + countObject, (String) null, new Object[0]);
            }
    ...
    public synchronized void registerStatClass(java.lang.Class<?> r17) {
        /*
            r16 = this;
            r0 = r17
            monitor-enter(r16)
            if (r0 == 0) goto L_0x00f7
            boolean r1 = mAppMonitorValid     // Catch:{ all -> 0x00f4 }
            if (r1 != 0) goto L_0x000b
            goto L_0x00f7
        L_0x000b:
            r1 = 0
            java.util.Set<java.lang.Class<?>> r2 = registeredStatClassSet     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x0064:
            java.util.Map<java.lang.reflect.Field, java.lang.String> r11 = field2Name     // Catch:{ Exception -> 0x00e7 }
            r11.put(r9, r10)     // Catch:{ Exception -> 0x00e7 }
            r6.addDimension((java.lang.String) r10)     // Catch:{ Exception -> 0x00e7 }
            goto L_0x00c8
        L_0x006d:
        ...
        L_0x008e:
            java.lang.String r11 = r10.name()     // Catch:{ Exception -> 0x00e7 }
        L_0x0092:
            java.util.Map<java.lang.reflect.Field, java.lang.String> r12 = field2Name     // Catch:{ Exception -> 0x00e7 }
            ...
            r7.addMeasure((com.alibaba.mtl.appmonitor.model.Measure) r9)     // Catch:{ Exception -> 0x00e7 }
            goto L_0x00c8
        L_0x00c5:
            r7.addMeasure((java.lang.String) r11)     // Catch:{ Exception -> 0x00e7 }
        L_0x00c8:
            int r8 = r8 + 1
            goto L_0x0039
        L_0x00cc:
            java.util.Map<java.lang.Class<?>, java.util.List<java.lang.reflect.Field>> r3 = dimensionFieldsCache     // Catch:{ Exception -> 0x00e7 }
            r3.put(r0, r4)     // Catch:{ Exception -> 0x00e7 }
            java.util.Map<java.lang.Class<?>, java.util.List<java.lang.reflect.Field>> r3 = measureFieldsCache     // Catch:{ Exception -> 0x00e7 }
            ...
            com.alibaba.mtl.appmonitor.AppMonitor.register((java.lang.String) r3, (java.lang.String) r2, (com.alibaba.mtl.appmonitor.model.MeasureSet) r7, (com.alibaba.mtl.appmonitor.model.DimensionSet) r6)     // Catch:{ Exception -> 0x00e7 }
            java.util.Set<java.lang.Class<?>> r2 = registeredStatClassSet     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x00f7:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: anet.channel.appmonitor.DefaultAppMonitor.registerStatClass(java.lang.Class):void");
    }
}
