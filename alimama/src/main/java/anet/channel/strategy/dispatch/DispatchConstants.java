...
public class DispatchConstants {
    ...
    public static String[][] AMDC_SERVER_FIX_IP = {new String[]{Utils.longToIP(203119206064L), Utils.longToIP(203119211219L)}, new String[]{Utils.longToIP(106011052006L)}, null};
