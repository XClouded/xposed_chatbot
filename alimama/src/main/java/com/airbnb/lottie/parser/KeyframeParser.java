...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.of("t", "s", "e", "o", UploadQueueMgr.MSGTYPE_INTERVAL, "h", "to", "ti");
    ...
    private static <T> com.airbnb.lottie.value.Keyframe<T> parseKeyframe(com.airbnb.lottie.LottieComposition r12, com.airbnb.lottie.parser.moshi.JsonReader r13, float r14, com.airbnb.lottie.parser.ValueParser<T> r15) throws java.io.IOException {
        ...
        L_0x005a:
            ...
            float r13 = com.airbnb.lottie.utils.MiscUtils.clamp((float) r13, (float) r2, (float) r0)
            r3.y = r13
            float r13 = r4.x
            float r13 = com.airbnb.lottie.utils.MiscUtils.clamp((float) r13, (float) r15, (float) r14)
            r4.x = r13
        ...
        L_0x00a0:
            ...
            java.lang.ref.WeakReference r14 = new java.lang.ref.WeakReference     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00b8 }
            r14.<init>(r1)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00b8 }
            putInterpolator(r13, r14)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00b8 }
        L_0x00b8:
            r7 = r1
            goto L_0x00bd
        L_0x00ba:
