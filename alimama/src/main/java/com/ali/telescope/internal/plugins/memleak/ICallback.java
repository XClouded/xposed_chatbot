...
public interface ICallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICallback {
        private static final String DESCRIPTOR = "com.ali.telescope.internal.plugins.memleak.ICallback";
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onResult(parcel.readInt() != 0 ? LeakResult.CREATOR.createFromParcel(parcel) : null);
        ...
        private static class Proxy implements ICallback {
            ...
            public void onResult(LeakResult leakResult) throws RemoteException {
                ...
                try {
                    ...
                    if (leakResult != null) {
                        obtain.writeInt(1);
                        leakResult.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
