...
public class AliWXEmbed extends WXEmbed {
    ...
    public void reload() {
        IConfigAdapter configAdapter = AliWeex.getInstance().getConfigAdapter();
        if ((configAdapter == null || !TextUtils.equals(configAdapter.getConfig("android_weex_ext_config", "embed_reload_destroy", Boolean.TRUE.toString()), Boolean.FALSE.toString())) && this.mNestedInstance != null) {
