...
public class UTClientConfigMgr {
    ...
    public synchronized void dispatchConfig(java.lang.String r6, java.lang.String r7) {
        /*
            ...
            r2 = 1
            r1[r2] = r6     // Catch:{ all -> 0x0044 }
            r2 = 2
            java.lang.String r4 = "value"
            r1[r2] = r4     // Catch:{ all -> 0x0044 }
            r2 = 3
            r1[r2] = r7     // Catch:{ all -> 0x0044 }
            com.alibaba.analytics.utils.Logger.d((java.lang.String) r0, (java.lang.Object[]) r1)     // Catch:{ all -> 0x0044 }
            boolean r0 = android.text.TextUtils.isEmpty(r6)     // Catch:{ all -> 0x0044 }
            if (r0 == 0) goto L_0x0021
            monitor-exit(r5)
            return
        L_0x0021:
            java.util.Map<java.lang.String, java.lang.String> r0 = r5.mConfigMap     // Catch:{ all -> 0x0044 }
            r0.put(r6, r7)     // Catch:{ all -> 0x0044 }
            java.util.Map<java.lang.String, java.util.List<com.alibaba.analytics.core.config.UTClientConfigMgr$IConfigChangeListener>> r0 = r5.mListeners     // Catch:{ all -> 0x0044 }
            java.lang.Object r6 = r0.get(r6)     // Catch:{ all -> 0x0044 }
            java.util.List r6 = (java.util.List) r6     // Catch:{ all -> 0x0044 }
            if (r6 == 0) goto L_0x0042
        L_0x0030:
            int r0 = r6.size()     // Catch:{ all -> 0x0044 }
            if (r3 >= r0) goto L_0x0042
            java.lang.Object r0 = r6.get(r3)     // Catch:{ all -> 0x0044 }
            com.alibaba.analytics.core.config.UTClientConfigMgr$IConfigChangeListener r0 = (com.alibaba.analytics.core.config.UTClientConfigMgr.IConfigChangeListener) r0     // Catch:{ all -> 0x0044 }
            r0.onChange(r7)     // Catch:{ all -> 0x0044 }
            int r3 = r3 + 1
            goto L_0x0030
        L_0x0042:
            monitor-exit(r5)
