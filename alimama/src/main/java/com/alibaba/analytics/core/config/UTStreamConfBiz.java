...
public class UTStreamConfBiz extends UTOrangeConfBiz {
    ...
    public synchronized java.lang.String getStreamName(java.util.Map<java.lang.String, java.lang.String> r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            com.alibaba.analytics.core.model.LogField r0 = com.alibaba.analytics.core.model.LogField.EVENTID     // Catch:{ all -> 0x0075 }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x0075 }
            boolean r0 = r5.containsKey(r0)     // Catch:{ all -> 0x0075 }
            r1 = -1
        ...
        L_0x0024:
            r2 = 0
            com.alibaba.analytics.core.model.LogField r3 = com.alibaba.analytics.core.model.LogField.ARG1     // Catch:{ all -> 0x0075 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0075 }
            boolean r3 = r5.containsKey(r3)     // Catch:{ all -> 0x0075 }
            if (r3 == 0) goto L_0x003e
            com.alibaba.analytics.core.model.LogField r2 = com.alibaba.analytics.core.model.LogField.ARG1     // Catch:{ all -> 0x0075 }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0075 }
            java.lang.Object r5 = r5.get(r2)     // Catch:{ all -> 0x0075 }
            r2 = r5
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ all -> 0x0075 }
        L_0x003e:
            java.lang.String r5 = r4._getStreamName(r0, r2)     // Catch:{ all -> 0x0075 }
        ...
        L_0x0046:
            int r5 = r0 % 10
            int r5 = r0 - r5
            java.lang.String r5 = r4._getStreamName(r5, r2)     // Catch:{ all -> 0x0075 }
        ...
        L_0x005e:
            ...
            return r5
        L_0x0069:
            java.lang.String r5 = r4._getStreamName(r1, r2)     // Catch:{ all -> 0x0075 }
    ...
    public synchronized void onOrangeConfigurationArrive(String str, Map<String, String> map) {
        ...
        for (String next : map.keySet()) {
            ...
            if (!(str2 == null || (parseJson = UTStreamItem.parseJson(str2)) == null)) {
    ...
    private static class UTStreamItem {
        ...
        public String getStmName(String str) {
            ...
            if (StringUtils.isEmpty(str) || (_getArg1StmName = _getArg1StmName(str)) == null) {
