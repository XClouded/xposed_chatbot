...
public class Device {
    ...
    private static void _checkIMEISI(Context context) {
        ...
        if (sharedPreferences2 != null && sharedPreferences != null) {
            String string = sharedPreferences.getString("EI", (String) null);
            String string2 = sharedPreferences.getString("SI", (String) null);
            if (!TextUtils.isEmpty(string) && !TextUtils.isEmpty(string2)) {
                String string3 = sharedPreferences2.getString("EI", (String) null);
                String string4 = sharedPreferences2.getString("SI", (String) null);
                ...
                if (_initDeviceMetadata != null) {
                    try {
                        ...
                        try {
                            ...
                            _initDeviceMetadata.setVersionCode("" + i);
                        ...
                        _initDeviceMetadata.setOsName(TimeCalculator.PLATFORM_ANDROID);
                        if (isYunOSSystem()) {
                        ...
                        try {
                            ...
                            _initDeviceMetadata.setScreenWidth(i2);
                            _initDeviceMetadata.setScreenHeight(i3);
                            if (i2 > i3) {
                                int i4 = i2 ^ i3;
                                i3 ^= i4;
                                i2 = i4 ^ i3;
                            }
                            _initDeviceMetadata.setResolution(i3 + "*" + i2);
