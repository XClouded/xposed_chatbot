...
public class ExceptionEventBuilder {
    ...
    private static JSONObject simulateDumpAlarmEvent(ExceptionType exceptionType, Throwable th) throws IOException {
        ...
        if (Variables.getInstance().getContext() != null) {
            jSONObject.put("pname", (Object) AppInfoUtil.getCurProcessName(Variables.getInstance().getContext()));
        }
        jSONObject.put("page", (Object) AP_MODULE);
        jSONObject.put("monitorPoint", (Object) getPoint(exceptionType));
