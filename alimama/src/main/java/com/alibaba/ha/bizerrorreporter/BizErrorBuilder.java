...
public class BizErrorBuilder {
    ...
    public abstract class ReportBuilder {
        ...
        public String buildBanner() {
            ...
            sb.append(String.format("Runtime Information: 'start: %s/maxheap: %s'\n", new Object[]{BizErrorReporter.getInstance().reporterStartTime, Long.valueOf(Runtime.getRuntime().maxMemory())}));
            sb.append(String.format("Application Information: 'version: %s/subversion: %s/buildseq: %s'\n", new Object[]{SendService.getInstance().appVersion, SendService.getInstance().appVersion, Build.ID}));
            sb.append(String.format("%s Information: 'version: %s/nativeseq: %s/javaseq: %s/target: %s'\n", new Object[]{BizErrorBuilder._MAGIC, "1.0.0.0", "160509105620", "", "beta"}));
        ...
        public java.lang.String buildFileDescriptor() {
            ...
            L_0x008b:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alibaba.ha.bizerrorreporter.BizErrorBuilder.ReportBuilder.buildFileDescriptor():java.lang.String");
        }

        /* access modifiers changed from: protected */
        public String buildLogcat() {
            return buildLogcat((String) null, 100) + buildLogcat(ProtocolConst.KEY_EVENTS, 100);
        }
    ...
    class SimpleJavaExceptionReportBuilder extends ReportBuilder {
        ...
        public java.lang.String buildThrowable() {
            /*
                ...
                java.lang.StringBuilder r0 = new java.lang.StringBuilder
                r0.<init>()
                com.alibaba.ha.bizerrorreporter.BizErrorReporter r1 = com.alibaba.ha.bizerrorreporter.BizErrorReporter.getInstance()     // Catch:{ Exception -> 0x00a6 }
                android.content.Context r2 = r7.mContext     // Catch:{ Exception -> 0x00a6 }
                java.lang.String r1 = r1.getProcessName(r2)     // Catch:{ Exception -> 0x00a6 }
                java.lang.String r2 = "Process Name: '%s' \n"
                r3 = 1
                java.lang.Object[] r4 = new java.lang.Object[r3]     // Catch:{ Exception -> 0x00a6 }
                r5 = 0
                r4[r5] = r1     // Catch:{ Exception -> 0x00a6 }
                java.lang.String r1 = java.lang.String.format(r2, r4)     // Catch:{ Exception -> 0x00a6 }
                ...
                java.lang.Object[] r2 = new java.lang.Object[r3]     // Catch:{ Exception -> 0x00a6 }
            ...
            L_0x0080:
                ...
                r0.append(r2)     // Catch:{ Exception -> 0x008c }
            L_0x0086:
                com.alibaba.motu.tbrest.utils.AppUtils.closeQuietly(r1)     // Catch:{ Exception -> 0x00a6 }
                goto L_0x0095
            L_0x008a:
                r2 = move-exception
                goto L_0x00a2
    ...
    public static String buildReportName(String str, String str2, long j, String str3, String str4) {
        ...
        return "BizErrorReporterSDK_1.0.0.0_df_df_df_df_" + str + "_" + replaceUnderscore + "_" + String.valueOf(j) + "_" + getGMT8Time(j) + "_" + StringUtils.defaultString(replaceUnderscore2, "df") + "_" + str4 + ".log";
    }
