        ...
        if (this.initing.compareAndSet(false, true)) {
            try {
                ...
                if (context2 == null) {
                    ...
                    this.mReporterContext.setProperty(new Propertys.Property(Constants.STARTUP_TIME, String.valueOf(currentTimeMillis)));
                    ...
                    this.mReporterContext.setProperty(new Propertys.Property("PROCESS_NAME", this.mProcessName, true));
                    ...
                    this.mStorageManager = new StorageManager(context2, this.mProcessName);
                    ...
                    String str5 = this.mProcessName;
                    StorageManager storageManager = this.mStorageManager;
                    StorageManager storageManager2 = storageManager;
                    RunningStateMonitor runningStateMonitor = r2;
                    RunningStateMonitor runningStateMonitor2 = new RunningStateMonitor(context, str, str2, str3, str5, currentTimeMillis, storageManager2, new DefaultStartupStateAnalyzeCallback());
                    this.mRunningStateMonitor = runningStateMonitor;
