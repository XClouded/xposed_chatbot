...
public class UTRestReq {
    ...
    public static boolean sendLog(Context context, long j, String str, int i, Object obj, Object obj2, Object obj3, Map<String, String> map) {
        try {
            if (!StringUtils.isBlank(CrashReporter.getInstance().getProperty("APP_KEY")) && !StringUtils.isBlank(CrashReporter.getInstance().getProperty(Constants.APP_VERSION))) {
                return SendService.getInstance().sendRequest((String) null, j, str, i, obj, obj2, obj3, map).booleanValue();
            }
            return false;
        } catch (Exception e) {
            LogUtil.e("sendLog", e);
    ...
    public static String sendLogByUrl(String str, Context context, long j, String str2, int i, Object obj, Object obj2, Object obj3, Map<String, String> map) {
        ...
        try {
            if (StringUtils.isBlank(CrashReporter.getInstance().getProperty("APP_KEY"))) {
                return "no appkey";
            }
