...
public class LruCache<K, V> {
    ...
    public final V get(K r5) {
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.ut.abtest.internal.util.LruCache.get(java.lang.Object):java.lang.Object");
    }
    ...
    public void trimToSize(int r5) {
        ...
        L_0x0000:
            monitor-enter(r4)
            int r0 = r4.size     // Catch:{ all -> 0x0075 }
            if (r0 < 0) goto L_0x0056
            java.util.LinkedHashMap<K, V> r0 = r4.map     // Catch:{ all -> 0x0075 }
        ...
        L_0x0032:
            ...
            java.util.LinkedHashMap<K, V> r2 = r4.map     // Catch:{ all -> 0x0075 }
            r2.remove(r1)     // Catch:{ all -> 0x0075 }
            int r2 = r4.size     // Catch:{ all -> 0x0075 }
            int r3 = r4.safeSizeOf(r1, r0)     // Catch:{ all -> 0x0075 }
            int r2 = r2 - r3
            r4.size = r2     // Catch:{ all -> 0x0075 }
            int r2 = r4.evictionCount     // Catch:{ all -> 0x0075 }
            r3 = 1
            int r2 = r2 + r3
            r4.evictionCount = r2     // Catch:{ all -> 0x0075 }
            monitor-exit(r4)     // Catch:{ all -> 0x0075 }
            r2 = 0
        ...
        L_0x0056:
            ...
            java.lang.Class r1 = r4.getClass()     // Catch:{ all -> 0x0075 }
        ...
        L_0x0075:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.ut.abtest.internal.util.LruCache.trimToSize(int):void");
    }
