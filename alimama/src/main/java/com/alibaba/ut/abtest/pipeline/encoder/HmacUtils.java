...
public final class HmacUtils {
    ...
    public String hmacHex(byte[] bArr) {
        return StringUtils.bytesToHexString(hmac(bArr));
    }
    ...
    public String hmacHex(String str) {
        return StringUtils.bytesToHexString(hmac(str));
    }
    ...
    public String hmacHex(ByteBuffer byteBuffer) {
        return StringUtils.bytesToHexString(hmac(byteBuffer));
    }
    ...
    public String hmacHex(InputStream inputStream) throws IOException {
        return StringUtils.bytesToHexString(hmac(inputStream));
    }
    ...
    public String hmacHex(File file) throws IOException {
        return StringUtils.bytesToHexString(hmac(file));
    }
}
