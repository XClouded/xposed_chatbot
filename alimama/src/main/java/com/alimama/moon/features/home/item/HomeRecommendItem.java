...
public class HomeRecommendItem extends CommonBaseItem {
    public BaseGoodsItem baseGoodsItem = new BaseGoodsItem();

    public HomeRecommendItem(String str, int i, JSONObject jSONObject) {
        ...
        this.baseGoodsItem.lensId = safeJSONObject.optString("lensId");
    }
}
