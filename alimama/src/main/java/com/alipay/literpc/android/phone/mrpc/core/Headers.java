...
public final class Headers {
    ...
    private static final String[] sHeaderNames = {TRANSFER_ENCODING, "content-length", "content-type", "content-encoding", CONN_DIRECTIVE, "location", PROXY_CONNECTION, WWW_AUTHENTICATE, PROXY_AUTHENTICATE, CONTENT_DISPOSITION, ACCEPT_RANGES, "expires", "cache-control", "last-modified", "etag", SET_COOKIE, PRAGMA, "refresh", X_PERMITTED_CROSS_DOMAIN_POLICIES};
