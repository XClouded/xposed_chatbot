...
public class JSONSerializer {
    private static List<ObjectSerializer> serializers = new ArrayList();

    static {
        serializers.add(new SimpleClassCodec());
    ...
    public static Object serializeToSimpleObject(Object obj) throws Exception {
        ...
        for (ObjectSerializer next : serializers) {
            if (next.match(obj.getClass()) && (serialize = next.serialize(obj)) != null) {
                return serialize;
            }
        }
