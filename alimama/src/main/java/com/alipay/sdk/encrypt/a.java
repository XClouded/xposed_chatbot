...
public final class a {
    ...
    static {
        ...
        int i7 = SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE;
        while (true) {
            i2 = 26;
            if (i7 < 97) {
                break;
        ...
        j[62] = '+';
        j[63] = DXTemplateNamePathUtil.DIR;
    }
    ...
    public static String a(byte[] bArr) {
        ...
        while (i4 < i3) {
            ...
            byte b5 = (byte) (b3 & 15);
            byte b6 = (byte) (b2 & 3);
            byte b7 = (byte) ((b2 & ByteCompanionObject.MIN_VALUE) == 0 ? b2 >> 2 : (b2 >> 2) ^ JfifUtil.MARKER_SOFn);
            byte b8 = (byte) ((b3 & ByteCompanionObject.MIN_VALUE) == 0 ? b3 >> 4 : (b3 >> 4) ^ 240);
            byte b9 = (byte) ((b4 & ByteCompanionObject.MIN_VALUE) == 0 ? b4 >> 6 : (b4 >> 6) ^ 252);
            int i10 = i6 + 1;
            cArr[i6] = j[b7];
            int i11 = i10 + 1;
            cArr[i10] = j[b8 | (b6 << 4)];
        ...
        if (i2 == 8) {
            ...
            byte b11 = (byte) (b10 & 3);
            int i13 = i6 + 1;
            cArr[i6] = j[(byte) ((b10 & ByteCompanionObject.MIN_VALUE) == 0 ? b10 >> 2 : (b10 >> 2) ^ JfifUtil.MARKER_SOFn)];
            int i14 = i13 + 1;
            cArr[i13] = j[b11 << 4];
            cArr[i14] = h;
            cArr[i14 + 1] = h;
            ...
            byte b15 = (byte) (b12 & 3);
            byte b16 = (byte) ((b12 & ByteCompanionObject.MIN_VALUE) == 0 ? b12 >> 2 : (b12 >> 2) ^ JfifUtil.MARKER_SOFn);
            byte b17 = (byte) ((b13 & ByteCompanionObject.MIN_VALUE) == 0 ? b13 >> 4 : (b13 >> 4) ^ 240);
            int i15 = i6 + 1;
            cArr[i6] = j[b16];
            int i16 = i15 + 1;
