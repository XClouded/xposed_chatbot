...
public class a {
    ...
    public class C0003a extends AlertDialog {
        protected C0003a(Context context) {
            super(context);
        }
        ...
        private android.graphics.drawable.Drawable a(android.content.Context r3, java.lang.String r4, int r5) {
            ...
            L_0x0049:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alipay.sdk.widget.a.C0003a.a(android.content.Context, java.lang.String, int):android.graphics.drawable.Drawable");
        }
