...
public class DOMStorage implements ChromeDevtoolsDomain {
    ...
    public void setDOMStorageItem(com.facebook.stetho.inspector.jsonrpc.JsonRpcPeer r10, org.json.JSONObject r11) throws org.json.JSONException, com.facebook.stetho.inspector.jsonrpc.JsonRpcException {
        /*
            ...
            android.content.SharedPreferences$Editor r4 = r1.edit()     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            ...
            goto L_0x00a2
        L_0x0042:
            com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException r4 = new com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            java.util.Locale r5 = java.util.Locale.US     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            java.lang.String r6 = "Type mismatch setting %s to %s (expected %s)"
            r7 = 3
            java.lang.Object[] r7 = new java.lang.Object[r7]     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            r7[r3] = r0     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            r3 = 1
            r7[r3] = r11     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            r3 = 2
            java.lang.Class r8 = r2.getClass()     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            java.lang.String r8 = r8.getSimpleName()     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            r7[r3] = r8     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            java.lang.String r3 = java.lang.String.format(r5, r6, r7)     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            r4.<init>(r3)     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            throw r4     // Catch:{ DOMStorageAssignmentException -> 0x007f }
        L_0x0063:
            com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException r3 = new com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            ...
            r4.append(r5)     // Catch:{ DOMStorageAssignmentException -> 0x007f }
            java.lang.String r4 = r4.toString()     // Catch:{ DOMStorageAssignmentException -> 0x007f }
