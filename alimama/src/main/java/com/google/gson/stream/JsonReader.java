...
public class JsonReader implements Closeable {
    ...
    private boolean isLiteral(char c) throws IOException {
        switch (c) {
            ...
            case '[':
            case ']':
            case SecExceptionCode.SEC_ERROR_INIT_INCORRECT_DATA_FILE:
            case '}':
                return false;
            case '#':
            case '/':
    ...
    public void skipValue() throws IOException {
        ...
        int i3 = this.stackSize - 1;
        iArr[i3] = iArr[i3] + 1;
        this.pathNames[this.stackSize - 1] = BuildConfig.buildJavascriptFrameworkVersion;
    }
    ...
    private boolean fillBuffer(int i) throws IOException {
        ...
        this.pos = 0;
        do {
            int read = this.f950in.read(cArr, this.limit, cArr.length - this.limit);
            if (read == -1) {
                return false;
            }
            this.limit += read;
