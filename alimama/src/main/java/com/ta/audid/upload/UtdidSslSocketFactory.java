...
class UtdidSslSocketFactory extends SSLSocketFactory {
    ...
    public Socket createSocket(Socket socket, String str, int i, boolean z) throws IOException {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            sSLCertificateSocketFactory.setTrustManagers(UtdidExtendTrustManager.getTrustManagers());
        }
        UtdidLogger.d("", "createSocket");
        ...
        UtdidLogger.d("", "createSocket end");
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            ...
            try {
                ...
                UtdidLogger.d("", "SNI not useable", e);
            }
        }
