...
public class MutiProcessLock {
    ...
    public static synchronized void releaseUtdidFile() {
        /*
            ...
            monitor-enter(r0)
            com.ta.audid.utils.UtdidLogger.d()     // Catch:{ all -> 0x0029 }
            java.nio.channels.FileLock r1 = mLock     // Catch:{ all -> 0x0029 }
            r2 = 0
            if (r1 == 0) goto L_0x0017
            java.nio.channels.FileLock r1 = mLock     // Catch:{ Exception -> 0x0010, all -> 0x0013 }
            r1.release()     // Catch:{ Exception -> 0x0010, all -> 0x0013 }
        L_0x0010:
            mLock = r2     // Catch:{ all -> 0x0029 }
            goto L_0x0017
        L_0x0013:
            r1 = move-exception
            mLock = r2     // Catch:{ all -> 0x0029 }
        ...
        L_0x0017:
            java.nio.channels.FileChannel r1 = fChannel     // Catch:{ all -> 0x0029 }
            if (r1 == 0) goto L_0x0027
            java.nio.channels.FileChannel r1 = fChannel     // Catch:{ Exception -> 0x0020, all -> 0x0023 }
            r1.close()     // Catch:{ Exception -> 0x0020, all -> 0x0023 }
        L_0x0020:
            fChannel = r2     // Catch:{ all -> 0x0029 }
            goto L_0x0027
        L_0x0023:
            r1 = move-exception
            fChannel = r2     // Catch:{ all -> 0x0029 }
    ...
    public static synchronized void releaseUpload() {
        /*
            ...
            monitor-enter(r0)
            com.ta.audid.utils.UtdidLogger.d()     // Catch:{ all -> 0x0029 }
            java.nio.channels.FileLock r1 = mUploadLock     // Catch:{ all -> 0x0029 }
            r2 = 0
            if (r1 == 0) goto L_0x0017
            java.nio.channels.FileLock r1 = mUploadLock     // Catch:{ Exception -> 0x0010, all -> 0x0013 }
            r1.release()     // Catch:{ Exception -> 0x0010, all -> 0x0013 }
        L_0x0010:
            mUploadLock = r2     // Catch:{ all -> 0x0029 }
            goto L_0x0017
        L_0x0013:
            r1 = move-exception
            mUploadLock = r2     // Catch:{ all -> 0x0029 }
            throw r1     // Catch:{ all -> 0x0029 }
        L_0x0017:
            java.nio.channels.FileChannel r1 = fUploadChannel     // Catch:{ all -> 0x0029 }
            if (r1 == 0) goto L_0x0027
            java.nio.channels.FileChannel r1 = fUploadChannel     // Catch:{ Exception -> 0x0020, all -> 0x0023 }
            r1.close()     // Catch:{ Exception -> 0x0020, all -> 0x0023 }
        L_0x0020:
            fUploadChannel = r2     // Catch:{ all -> 0x0029 }
            goto L_0x0027
        L_0x0023:
            r1 = move-exception
            fUploadChannel = r2     // Catch:{ all -> 0x0029 }
