...
public class AssembleMessage {
            ...
            public void run() {
                synchronized (AssembleMessage.this) {
                    if (AssembleMessage.this.status == 0) {
                        ...
                        int unused = AssembleMessage.this.status = 1;
                        AssembleMessage.this.burstMessages.clear();
                        AppMonitor.getInstance().commitStat(new AssembleMonitor(AssembleMessage.this.dataId, String.valueOf(AssembleMessage.this.status)));
                    }
                }
            }
    ...
    public byte[] putBurst(int r13, int r14, byte[] r15) {
        ...
        L_0x00a5:
            ...
            byte[] r7 = org.android.agoo.common.EncryptUtil.md5(r14)     // Catch:{ all -> 0x015c }
