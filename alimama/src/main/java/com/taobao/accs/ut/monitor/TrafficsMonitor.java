...
public class TrafficsMonitor {
    ...
    public static class TrafficInfo {
        ...
        public String toString() {
            return "date:" + this.date + Operators.SPACE_STR + "bizId:" + this.bid + Operators.SPACE_STR + "serviceId:" + this.serviceId + Operators.SPACE_STR + "host:" + this.host + Operators.SPACE_STR + "isBackground:" + this.isBackground + Operators.SPACE_STR + "size:" + this.trafficSize;
        }
    }
}
