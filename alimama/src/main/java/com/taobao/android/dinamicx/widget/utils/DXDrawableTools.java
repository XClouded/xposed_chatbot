...
public class DXDrawableTools {
    public static final int[] STATE_CHECKED = {16842912};

    public static GradientDrawable getShape(int i, int i2, int i3, int i4, int i5, int i6) {
    ...
    public static StateListDrawable getCheckBoxSelector(Drawable drawable, Drawable drawable2, Drawable drawable3, Drawable drawable4) {
