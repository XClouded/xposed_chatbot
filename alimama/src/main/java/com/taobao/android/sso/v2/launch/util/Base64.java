...
public final class Base64 {
    ...
    static {
        ...
        lookUpBase64Alphabet[63] = DXTemplateNamePathUtil.DIR;
    }
    ...
    public static String encode(byte[] bArr) {
        ...
        while (i3 < i2) {
            ...
            byte b8 = (byte) ((b3 & ByteCompanionObject.MIN_VALUE) == 0 ? b3 >> 6 : (b3 >> 6) ^ 252);
            int i9 = i5 + 1;
        ...
        if (i == 8) {
            ...
            byte b10 = (byte) (b9 & 3);
            int i12 = i5 + 1;
            cArr[i5] = lookUpBase64Alphabet[(byte) ((b9 & ByteCompanionObject.MIN_VALUE) == 0 ? b9 >> 2 : (b9 >> 2) ^ JfifUtil.MARKER_SOFn)];
            int i13 = i12 + 1;
