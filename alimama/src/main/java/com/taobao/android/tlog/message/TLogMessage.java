...
public class TLogMessage implements MessageSender {
    ...
    public void init(MessageInfo messageInfo) {
        try {
            ...
            ACCSClient.getAccsClient(str3).registerDataListener(str2, new TLogCommandDataCenter());
    ...
    public MessageReponse sendMsg(MessageInfo messageInfo) {
        ...
        try {
            ACCSClient.getAccsClient(str4).sendRequest(new ACCSManager.AccsRequest(UploadConstants.USERID, str3, str2.getBytes(), (String) null));
