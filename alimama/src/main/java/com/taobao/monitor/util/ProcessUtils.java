...
public final class ProcessUtils {
    ...
    public static String getCurrProcessName() {
        ...
        if (TextUtils.isEmpty(sProcessName)) {
            ...
            if (TextUtils.isEmpty(currentProcessNameViaLinuxFile) && context != null) {
                currentProcessNameViaLinuxFile = getCurrentProcessNameViaActivityManager(context);
            }
    ...
    private static java.lang.String getCurrentProcessNameViaLinuxFile() {
        ...
        L_0x004b:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.monitor.util.ProcessUtils.getCurrentProcessNameViaLinuxFile():java.lang.String");
    }
