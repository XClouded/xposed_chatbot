    ...
    public void init(Application application, HashMap<String, Object> hashMap) {
        ...
        try {
            ...
            try {
                ...
                OrangeConfig.getInstance().init(application, new OConfig.Builder().setAppKey(str3).setAppVersion(str).setEnv(i).setServerType(OConstant.SERVER.TAOBAO.ordinal()).setIndexUpdateMode(OConstant.UPDMODE.O_XMD.ordinal()).setReportAck(false).setStatUsedConfig(true).setTime(-1).build());
            }
            try {
