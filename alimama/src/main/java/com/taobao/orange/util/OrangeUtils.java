...
public class OrangeUtils {
        ...
        try {
            for (Map.Entry next : map.entrySet()) {
                if (next.getKey() != null) {
                    ...
                    sb.append(URLEncoder.encode(next.getValue() == null ? "" : (String) next.getValue(), str).replace("+", "%20"));
                    sb.append("&");
                }
            }
    ...
    public static String formatIndexDO(IndexDO indexDO) {
        ...
        return JSON.toJSONString((Object) indexDO, (SerializeFilter) simplePropertyPreFilter, SerializerFeature.PrettyFormat);
    }
