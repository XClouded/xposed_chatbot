...
public class HotEndLruCache<K, V> implements LruCache<K, V> {
    ...
    private HashMap<K, LruNode<K, V>> mLocationMap = new HashMap<>();
    ...
    private void checkMaxSizes() {
        boolean z = this.MAX_PRE_EVICTED_SIZE < this.MAX_LIMIT_SIZE;
        Preconditions.checkArgument(z, "MAX_PRE_EVICTED_SIZE(" + this.MAX_PRE_EVICTED_SIZE + ") must lower than MAX_LIMIT_SIZE(" + this.MAX_LIMIT_SIZE + Operators.BRACKET_END_STR);
    }
    ...
    private void onNodeRemoved(boolean z, LruNode<K, V> lruNode, boolean z2) {
        changeNodePreEvictedState(lruNode, false, z2, true);
        onNodeRemoved(z, lruNode.key, lruNode.value);
    }

    private void changeNodePreEvictedState(LruNode<K, V> lruNode, boolean z, boolean z2, boolean z3) {
        boolean z4;
        synchronized (this) {
        ...
        if (z4 && z2) {
            onPreEvictedStateChange(z, lruNode.key, lruNode.value, z3);
        }
    }
    ...
    public final boolean trimTo(int r6) {
        ...
        L_0x000b:
            ...
            return r2
        L_0x000d:
            com.taobao.phenix.cache.LruNode<K, V> r0 = r5.mHotHead     // Catch:{ all -> 0x0050 }
            com.taobao.phenix.cache.LruNode<K, V> r0 = r0.prev     // Catch:{ all -> 0x0050 }
        ...
        L_0x0023:
            ...
            com.taobao.phenix.cache.LruNode<K, V> r0 = r5.mColdHead     // Catch:{ all -> 0x0050 }
            com.taobao.phenix.cache.LruNode<K, V> r0 = r0.prev     // Catch:{ all -> 0x0050 }
        ...
        L_0x0038:
            com.taobao.phenix.cache.LruNode<K, V> r0 = r5.mHotHead     // Catch:{ all -> 0x0050 }
            com.taobao.phenix.cache.LruNode<K, V> r0 = r0.prev     // Catch:{ all -> 0x0050 }
            java.util.HashMap<K, com.taobao.phenix.cache.LruNode<K, V>> r1 = r5.mLocationMap     // Catch:{ all -> 0x0050 }
        ...
        L_0x0050:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.phenix.cache.HotEndLruCache.trimTo(int):boolean");
    }
    ...
    private synchronized void preTrimToMaxSize(boolean r4) {
        /*
            r3 = this;
            monitor-enter(r3)
            com.taobao.phenix.cache.LruNode<K, V> r0 = r3.mHotHead     // Catch:{ all -> 0x002f }
            if (r0 == 0) goto L_0x002d
            if (r4 != 0) goto L_0x000e
            int r4 = r3.mCurrSize     // Catch:{ all -> 0x002f }
            int r0 = r3.mSizeWhenLastPreEvict     // Catch:{ all -> 0x002f }
            if (r4 > r0) goto L_0x000e
            goto L_0x002d
        L_0x000e:
            com.taobao.phenix.cache.LruNode<K, V> r4 = r3.mHotHead     // Catch:{ all -> 0x002f }
            com.taobao.phenix.cache.LruNode<K, V> r4 = r4.prev     // Catch:{ all -> 0x002f }
            r0 = r4
        L_0x0013:
            int r1 = r3.mPreEvictedSize     // Catch:{ all -> 0x002f }
            int r2 = r3.MAX_PRE_EVICTED_SIZE     // Catch:{ all -> 0x002f }
            if (r1 >= r2) goto L_0x0027
            int r1 = r0.visitCount     // Catch:{ all -> 0x002f }
            r2 = 2
            if (r1 >= r2) goto L_0x0023
            r1 = 0
            r2 = 1
            r3.changeNodePreEvictedState(r0, r2, r2, r1)     // Catch:{ all -> 0x002f }
        L_0x0023:
            com.taobao.phenix.cache.LruNode<K, V> r0 = r0.prev     // Catch:{ all -> 0x002f }
            if (r0 != r4) goto L_0x0013
        L_0x0027:
            int r4 = r3.mCurrSize     // Catch:{ all -> 0x002f }
            r3.mSizeWhenLastPreEvict = r4     // Catch:{ all -> 0x002f }
            monitor-exit(r3)
            return
        L_0x002d:
            monitor-exit(r3)
        ...
        L_0x002f:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.phenix.cache.HotEndLruCache.preTrimToMaxSize(boolean):void");
    }

    public void board(String str) {
        if (UnitedLog.isLoggable(3)) {
            UnitedLog.d(str, "%K(%K)/%K, pre-evicted:%K/%K, rate:%.1f%%, count:%d, hits:%d, misses:%d, evicts:%d", Integer.valueOf(this.mCurrSize), Integer.valueOf(this.mHotSize), Integer.valueOf(this.MAX_LIMIT_SIZE), Integer.valueOf(this.mPreEvictedSize), Integer.valueOf(this.MAX_PRE_EVICTED_SIZE), Float.valueOf((((float) this.mHitCount) * 100.0f) / ((float) (this.mHitCount + this.mMissCount))), Integer.valueOf(count()), Integer.valueOf(this.mHitCount), Integer.valueOf(this.mMissCount), Integer.valueOf(this.mEvictCount));
        }
    }
