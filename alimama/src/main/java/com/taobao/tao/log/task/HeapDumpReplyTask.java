...
public class HeapDumpReplyTask implements GodEyeReponse {
    ...
    public void execute(String str, String str2, JSONObject jSONObject, String str3, String str4, String str5) {
        ...
        heapDumpReply.tokenType = uploadInfo.type;
    ...
    public class HeapDumpThread extends Thread {
        ...
        public HeapDumpThread(String str, String str2, String str3, FileUploadListener fileUploadListener2) {
            super(str);
            this.uploadId = str2;
            this.filePath = str3;
        ...
        public void run() {
            try {
                ...
                if (this.uploadId != null) {
                    ...
                    ApplyTokenRequestTask.execute(this.uploadId, arrayList, "application/x-perf-heapdump");
                    return;
                }
                ...
                e.printStackTrace();
                TLogInitializer.getInstance().gettLogMonitor().stageError(TLogStage.MSG_HANDLE, HeapDumpReplyTask.this.TAG, (Throwable) e);
            }
        }
    }
}
