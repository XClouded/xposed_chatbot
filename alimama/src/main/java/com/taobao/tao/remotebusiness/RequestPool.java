...
public class RequestPool {
    ...
    public void addToRequestPool(@NonNull Mtop mtop, @Nullable String str, MtopBusiness mtopBusiness) {
        ...
        try {
            ...
            List list = this.requestPool.get(requestPoolKey);
            if (list == null) {
                list = new ArrayList();
            }
    ...
    public void failAllRequest(@NonNull Mtop mtop, @Nullable String str, String str2, String str3) {
        ...
        try {
            ...
            if (remove != null) {
                if (!remove.isEmpty()) {
                    ...
                    for (MtopBusiness mtopBusiness : remove) {
                        ...
                        HandlerParam handlerMsg = HandlerMgr.getHandlerMsg((MtopListener) null, (MtopEvent) null, mtopBusiness);
            ...
            TBSdkLog.e(TAG, "[failAllRequest] do ErrorCode Mapping error.apiKey=" + mtopResponse.getFullKey(), (Throwable) e);
        } catch (Throwable th) {
            this.lock.unlock();
            throw th;
        }
