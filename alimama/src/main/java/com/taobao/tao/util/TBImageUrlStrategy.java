...
public class TBImageUrlStrategy {
    ...
    /* synthetic */ TBImageUrlStrategy(AnonymousClass1 r1) {
        this();
    }
    ...
    public static class Area {
        ...
        public static final Area home = new Area(ImageStrategyConfig.HOME);
    ...
    private static class TBImageUrlStrategyHolder {
        public static final TBImageUrlStrategy instance = new TBImageUrlStrategy((AnonymousClass1) null);
    ...
    public String decideLowNetUrl(String str, int i, Area area, CutType cutType) {
        return decideUrl(str, i, area, 0, -1, -1, cutType, true, true, true);
    }
    ...
    public String decideUrl(String str, int i) {
        return decideUrl(str, i, Area.non, 0, -1, -1, CutType.non);
    }

    public String decideUrl(String str, int i, CutType cutType) {
        return decideUrl(str, i, Area.non, 0, -1, -1, cutType);
    }

    public String decideUrl(String str, int i, Area area) {
        return decideUrl(str, i, area, 0, -1, -1, CutType.non);
    }
    ...
    private String decideUrl(String str, int i, Area area, long j, int i2, int i3, CutType cutType, boolean z, boolean z2, boolean z3) {
        ...
        if (!TaobaoImageUrlStrategy.getInstance().isCdnImage(str)) {
            Logger.w(Logger.COMMON_TAG, "origin not cdn url:%s", str2);
            return str2;
        }
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$taobao$tao$util$TBImageUrlStrategy$CutType = new int[CutType.values().length];

        static {
            try {
                $SwitchMap$com$taobao$tao$util$TBImageUrlStrategy$CutType[CutType.xz.ordinal()] = 1;
