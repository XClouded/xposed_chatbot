        ...
        super.setOnHierarchyChangeListener(new ViewGroup.OnHierarchyChangeListener() {
            public void onChildViewAdded(View view, View view2) {
                ...
                for (int i = 0; i < size; i++) {
                    ((ViewGroup.OnHierarchyChangeListener) TScrollView.this.mOnHierarchyChangeListeners.get(i)).onChildViewAdded(view, view2);
                }
            }
            ...
            public void onChildViewRemoved(View view, View view2) {
                int size = TScrollView.this.mOnHierarchyChangeListeners.size();
                for (int i = 0; i < size; i++) {
                    ((ViewGroup.OnHierarchyChangeListener) TScrollView.this.mOnHierarchyChangeListeners.get(i)).onChildViewRemoved(view, view2);
                }
            }
        });
    }
