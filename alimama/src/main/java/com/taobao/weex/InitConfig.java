...
public class InitConfig {
    ...
    public static class Builder {
        ...
        public InitConfig build() {
            ...
            IWebSocketAdapterFactory unused9 = initConfig.webSocketAdapterFactory = this.webSocketAdapterFactory;
            IWXJSExceptionAdapter unused10 = initConfig.mJSExceptionAdapter = this.mJSExceptionAdapter;
            ClassLoaderAdapter unused11 = initConfig.classLoaderAdapter = this.classLoaderAdapter;
            IApmGenerator unused12 = initConfig.apmGenerater = this.apmGenerater;
            IWXJsFileLoaderAdapter unused13 = initConfig.jsFileLoaderAdapter = this.jsFileLoaderAdapter;
            IWXJscProcessManager unused14 = initConfig.jscProcessManager = this.jscProcessManager;
            List unused15 = initConfig.nativeLibraryList = this.nativeLibraryList;
            IWXFoldDeviceAdapter unused16 = initConfig.foldDeviceAdapter = this.foldDeviceAdapter;
            return initConfig;
        }
    }
}
