    ...
    private static abstract class WaitableRunnable<V> implements Runnable {
        ...
        public final void run() {
            ...
            L_0x002f:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.taobao.weex.devtools.common.android.HandlerUtil.WaitableRunnable.run():void");
        }
        ...
        private void join() {
            ...
            L_0x000b:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.taobao.weex.devtools.common.android.HandlerUtil.WaitableRunnable.join():void");
        }
    }
}
