...
public final class Document extends ThreadBoundProxy {
    ...
    private void init() {
        ...
        this.mDocumentProvider.postAndWait((Runnable) new Runnable() {
            public void run() {
                ShadowDocument unused = Document.this.mShadowDocument = new ShadowDocument(Document.this.mDocumentProvider.getRootElement());
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x0029 A[ORIG_RETURN, RETURN, SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean doesElementMatch(java.lang.Object r2, int r3, int r4) {
        /*
            r1 = this;
            boolean r0 = com.taobao.weex.devtools.inspector.protocol.module.DOM.isNativeMode()
            ...
            goto L_0x0019
        L_0x000d:
            boolean r0 = r2 instanceof com.taobao.weex.ui.component.WXComponent
            if (r0 == 0) goto L_0x0018
        ...
        L_0x0019:
            ...
            boolean r3 = isPointInsideView(r3, r4, r2)
        ...
        L_0x002a:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.weex.devtools.inspector.elements.Document.doesElementMatch(java.lang.Object, int, int):boolean");
    }
