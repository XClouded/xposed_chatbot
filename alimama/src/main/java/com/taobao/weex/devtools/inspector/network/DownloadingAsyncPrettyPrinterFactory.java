    ...
    public AsyncPrettyPrinter getInstance(String str, String str2) {
        ...
        return new AsyncPrettyPrinter() {
            /* JADX WARNING: Code restructure failed: missing block: B:15:0x0041, code lost:
                com.taobao.weex.devtools.inspector.network.DownloadingAsyncPrettyPrinterFactory.access$000(r4, r5, "Encountered spurious interrupt while downloading schema for pretty printing: " + r0.getMessage());
             */
            ...
            public void printTo(java.io.PrintWriter r4, java.io.InputStream r5) throws java.io.IOException {
                /*
                    ...
                    com.taobao.weex.devtools.inspector.network.DownloadingAsyncPrettyPrinterFactory r1 = com.taobao.weex.devtools.inspector.network.DownloadingAsyncPrettyPrinterFactory.this     // Catch:{ InterruptedException -> 0x000e, ExecutionException -> 0x0037 }
                ...
                L_0x0010:
                    ...
                    com.taobao.weex.devtools.inspector.network.DownloadingAsyncPrettyPrinterFactory.doErrorPrint(r4, r5, r0)     // Catch:{ InterruptedException -> 0x000e, ExecutionException -> 0x0037 }
                    return
                L_0x0036:
                ...
                L_0x0037:
                    ...
                    java.lang.RuntimeException r4 = com.taobao.weex.devtools.common.ExceptionUtil.propagate(r4)
                    throw r4
                L_0x0041:
                    ...
                    com.taobao.weex.devtools.inspector.network.DownloadingAsyncPrettyPrinterFactory.doErrorPrint(r4, r5, r0)
                L_0x0059:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.taobao.weex.devtools.inspector.network.DownloadingAsyncPrettyPrinterFactory.AnonymousClass1.printTo(java.io.PrintWriter, java.io.InputStream):void");
            }
