...
class GunzippingOutputStream extends FilterOutputStream {
    ...
    private static <T> T getAndRethrow(java.util.concurrent.Future<T> r2) throws java.io.IOException {
        ...
        L_0x0005:
            ...
            com.taobao.weex.devtools.common.ExceptionUtil.propagateIfInstanceOf(r0, r1)
            com.taobao.weex.devtools.common.ExceptionUtil.propagate(r0)
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.weex.devtools.inspector.network.GunzippingOutputStream.getAndRethrow(java.util.concurrent.Future):java.lang.Object");
    }
