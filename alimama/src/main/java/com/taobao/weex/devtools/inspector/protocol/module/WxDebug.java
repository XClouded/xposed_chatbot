...
public class WxDebug implements ChromeDevtoolsDomain {
    ...
    static {
        ...
        sLevelMap.put(ApiConstants.ApiField.INFO, LogLevel.INFO);
    ...
    public void enable(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (application != null) {
            ...
            Intent action = new Intent().setAction(WXSDKInstance.ACTION_DEBUG_INSTANCE_REFRESH);
            if (jSONObject == null) {
                str = "";
            } else {
                str = jSONObject.toString();
            }
            application.sendBroadcast(action.putExtra("params", str));
