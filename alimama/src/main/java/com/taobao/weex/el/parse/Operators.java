...
public class Operators {
    ...
    public static Object plus(Token token, Token token2, Object obj) {
        ...
        if ((execute instanceof CharSequence) || (execute2 instanceof CharSequence)) {
            ...
            sb.append(execute2 == null ? "" : execute2.toString());
            return sb.toString();
            ...
            sb2.append(execute2 == null ? "" : execute2.toString());
            return sb2.toString();
        }
    }
    ...
    public static boolean isTrue(Object obj) {
        ...
        if (!(obj instanceof Number)) {
            ...
            return !"false".equals(trim) && !Constants.Name.UNDEFINED.equals(trim) && !BuildConfig.buildJavascriptFrameworkVersion.equals(trim) && !isEmpty(trim);
    ...
    static {
        ...
        KEYWORDS.put(BuildConfig.buildJavascriptFrameworkVersion, (Object) null);
