...
public class Status {
    ...
    static {
        statusMap.put(MessageService.MSG_DB_COMPLETE, "Continue");
        statusMap.put(OConstant.CODE_POINT_EXP_BIND_SERVICE, "Switching Protocol");
        statusMap.put(AlipayAuthConstant.LoginResult.SUCCESS, WXModalUIModule.OK);
        ...
        statusMap.put(TaobaoConstants.DEVICETOKEN_ERROR, "Gateway Timeout");
