...
public class WXStateRecord {
    ...
    public Map<String, String> getStateInfo() {
        ...
        if (wxConfigAdapter != null && "true".equalsIgnoreCase(wxConfigAdapter.getConfig(WXInitConfigManager.WXAPM_CONFIG_GROUP, "dumpIpcPageInfo", "true"))) {
    ...
    private static class Info implements Comparable<Info> {
        ...
        public String toString() {
            return Operators.ARRAY_START + this.instanceId + ',' + this.time + ',' + this.msg + "]->";
        }
        ...
        public int compareTo(@NonNull Info info) {
            ...
            return this.time > info.time ? 1 : -1;
        }
    }
