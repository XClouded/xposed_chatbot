        ...
        if (this.mAnimationBean != null) {
            ...
            if ((wXComponent != null || (TemplateDom.isVirtualDomRef(getRef()) && (wXComponent = TemplateDom.findVirtualComponentByVRef(getPageId(), getRef())) != null)) && (wXSDKInstance = WXSDKManager.getInstance().getWXRenderManager().getWXSDKInstance(getPageId())) != null && this.mAnimationBean.styles != null) {
                if (this.styleNeedInit) {
                    ...
                    this.mAnimationBean.styles.init(this.mAnimationBean.styles.transformOrigin, this.mAnimationBean.styles.transform, (int) wXComponent.getLayoutWidth(), (int) wXComponent.getLayoutHeight(), wXSDKInstance.getInstanceViewPortWidth(), wXSDKInstance);
                }
    ...
    private ObjectAnimator createAnimator(View view, int i) {
        ...
        if (view.getLayoutParams() != null && (!TextUtils.isEmpty(style.width) || !TextUtils.isEmpty(style.height))) {
            ...
            if (!TextUtils.isEmpty(style.width)) {
                holders.add(PropertyValuesHolder.ofInt(new WidthProperty(), new int[]{layoutParams.width, (int) WXViewUtils.getRealPxByWidth(WXUtils.getFloat(style.width), i)}));
            }
            if (!TextUtils.isEmpty(style.height)) {
                holders.add(PropertyValuesHolder.ofInt(new HeightProperty(), new int[]{layoutParams.height, (int) WXViewUtils.getRealPxByWidth(WXUtils.getFloat(style.height), i)}));
            }
        }
