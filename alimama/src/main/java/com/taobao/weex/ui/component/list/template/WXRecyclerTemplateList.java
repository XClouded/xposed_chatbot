...
public class WXRecyclerTemplateList extends WXVContainer<BounceRecyclerView> implements IRecyclerAdapterListener<TemplateViewHolder>, IOnLoadMoreListener, Scrollable {
    ...
    public void bindStickStyle(WXComponent wXComponent) {
        ...
        if (findParentType != null && this.mStickyHelper != null && !this.mStickyHelper.getStickyTypes().contains(findParentType.getRef())) {
    ...
    public void scrollTo(String str, Map<String, Object> map) {
        ...
        try {
            if (str.indexOf(64) > 0) {
                i = Integer.parseInt(str.split(DinamicConstant.DINAMIC_PREFIX_AT)[0]);
            } else {
            ...
            if (i >= 0) {
                ...
                boolean z = true;
                if (map != null) {
                    WXUtils.getBoolean(map.get("animated"), true).booleanValue();
    ...
    public boolean setProperty(java.lang.String r4, java.lang.Object r5) {
        /*
            ...
            r2 = 1
            switch(r0) {
                case -889473228: goto L_0x0080;
                case -713683669: goto L_0x0075;
                case -338674661: goto L_0x006a;
                case -223520855: goto L_0x005f;
                case -112563826: goto L_0x0055;
                case -5620052: goto L_0x004a;
                case 3046192: goto L_0x0040;
                case 66669991: goto L_0x0036;
                case 92902992: goto L_0x002c;
                case 100346066: goto L_0x0022;
                case 1345164648: goto L_0x0017;
                case 1614714674: goto L_0x000c;
        ...
        L_0x00cf:
            ...
            java.lang.String r4 = com.taobao.weex.utils.WXUtils.getString(r5, r4)
            r3.listDataTemplateKey = r4
            return r2
        L_0x00d8:
            java.lang.String r4 = r3.listDataIndexKey
            java.lang.String r4 = com.taobao.weex.utils.WXUtils.getString(r5, r4)
            r3.listDataIndexKey = r4
            return r2
        L_0x00e1:
            java.lang.String r4 = r3.listDataItemKey
            java.lang.String r4 = com.taobao.weex.utils.WXUtils.getString(r5, r4)
            r3.listDataItemKey = r4
            return r2
        L_0x00ea:
            r3.setListData(r5)
            return r2
    ...
    public int getItemCount() {
        if (!this.hasLayoutDone || !this.hasAppendTreeDone || this.cellDataManager.listData == null || this.mTemplateViewTypes == null || this.mTemplateViewTypes.size() <= 1 || this.mTemplateSources == null || this.mTemplateSources.size() == 0) {
            return 0;
        }
    ...
    public void onLoadMore(int i) {
        try {
            ...
            if (((float) i) <= WXViewUtils.getRealPxByWidth((float) Integer.parseInt(loadMoreOffset), getInstance().getInstanceViewPortWidth()) && this.cellDataManager.listData != null) {
