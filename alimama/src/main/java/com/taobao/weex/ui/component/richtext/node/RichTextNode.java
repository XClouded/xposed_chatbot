...
public abstract class RichTextNode {
    ...
    public void removeChildNode(String str) {
        if (this.children != null && !this.children.isEmpty() && !TextUtils.isEmpty(str)) {
            try {
    ...
    private WXCustomStyleSpan createCustomStyleSpan() {
        int fontWeight = this.style.containsKey("fontWeight") ? WXStyle.getFontWeight(this.style) : -1;
        int fontStyle = this.style.containsKey("fontStyle") ? WXStyle.getFontStyle(this.style) : -1;
        String fontFamily = this.style.containsKey("fontFamily") ? WXStyle.getFontFamily(this.style) : null;
    ...
    public RichTextNode findRichNode(String str) {
        if (this.mRef != null && TextUtils.equals(this.mRef, str)) {
            return this;
        }
