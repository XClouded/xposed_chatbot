...
public class BorderDrawable extends Drawable {
    ...
    public boolean isRounded() {
        return (this.mBorderRadius == null || (this.mBorderRadius.get(CSSShorthand.CORNER.BORDER_TOP_LEFT) == 0.0f && this.mBorderRadius.get(CSSShorthand.CORNER.BORDER_TOP_RIGHT) == 0.0f && this.mBorderRadius.get(CSSShorthand.CORNER.BORDER_BOTTOM_RIGHT) == 0.0f && this.mBorderRadius.get(CSSShorthand.CORNER.BORDER_BOTTOM_LEFT) == 0.0f)) ? false : true;
    }
    ...
    private float getBorderRadius(CSSShorthand.CORNER corner) {
        if (this.mOverlappingBorderRadius != null) {
            return this.mOverlappingBorderRadius.get(corner);
        }
        return 0.0f;
    }
