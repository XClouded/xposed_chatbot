...
public abstract class BaseBounceView<T extends View> extends FrameLayout {
    ...
    public void setHeaderView(WXComponent wXComponent) {
        ...
        if (this.swipeLayout != null && (headerView = this.swipeLayout.getHeaderView()) != null && wXComponent != null) {
    ...
    public void setFooterView(WXComponent wXComponent) {
        ...
        if (this.swipeLayout != null && (footerView = this.swipeLayout.getFooterView()) != null && wXComponent != null) {
