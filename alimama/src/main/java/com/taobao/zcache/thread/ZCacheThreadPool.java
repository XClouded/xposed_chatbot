...
public class ZCacheThreadPool {
    ...
    private static String TAG = "ZCacheThreadPool";
    private static ZCacheThreadPool threadManager;
    ...
    public void execute(Runnable runnable, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            String str2 = TAG;
            ZLog.d(str2, "overlap the same name task:[" + str + Operators.ARRAY_END_STR);
        } else {
            ...
            String str4 = TAG;
            ZLog.d(str4, "remove first task:[" + str3 + Operators.ARRAY_END_STR);
        }
        String str5 = TAG;
        ZLog.d(str5, "activeTask count after:" + ((ThreadPoolExecutor) this.executor).getActiveCount());
    }
