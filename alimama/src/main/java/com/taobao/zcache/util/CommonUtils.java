...
public class CommonUtils {
    ...
    public static boolean isLowendPhone() {
        ...
        ZLog.d("HomePageNetwork", "processorCore = " + numCores + " ram = " + totalRAM + " MB");
    ...
    public static int getTotalRAM() {
        ...
        L_0x005d:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.zcache.util.CommonUtils.getTotalRAM():int");
    }
    ...
    public static int getNumCores() {
        try {
            ...
            ZLog.d("HomePageNetwork", "CPU Count: " + listFiles.length);
            return listFiles.length;
        } catch (Exception e) {
            ZLog.d("HomePageNetwork", "CPU Count: Failed.");
            e.printStackTrace();
            return 1;
        }
    }
