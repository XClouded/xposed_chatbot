...
public class BusinessWrapper {
    ...
    public static SetupTask decompressAndODex(String str, Object obj) throws UCSetupException {
        return (SetupTask) ((SetupTask) ((SetupTask) ((SetupTask) new o().setup(UCCore.OPTION_SETUP_THREAD_PRIORITY, (Object) -20)).setup(UCCore.OPTION_ROOT_TASK_KEY, (Object) "decompressAndODex")).setup(UCCore.OPTION_CONTINUE_ODEX_ON_DECOMPRESSED, (Object) true)).setup(str, obj);
    }
}
