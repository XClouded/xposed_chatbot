...
public final class t extends WebViewClient {
    ...
    public final WebResourceResponse shouldInterceptRequest(android.webkit.WebView webView, String str) {
        ...
        if (shouldInterceptRequest == null) {
            try {
                if (!(this.a == null || this.a.isDestroied() || (settings = this.a.getSettings()) == null || (preCacheScope = settings.getPreCacheScope()) == null || preCacheScope.length() <= 0 || (l = SDKFactory.l()) == null)) {
                    shouldInterceptRequest = l.getPreloadResource(preCacheScope, "common", str);
                }
            } catch (Throwable th) {
                th.printStackTrace();
            }
