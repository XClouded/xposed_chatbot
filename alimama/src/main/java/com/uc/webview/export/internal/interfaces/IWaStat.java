...
public interface IWaStat {
    ...
    public static class WaStat {
        ...
        public static void statPV(String str) {
            ...
            if (a.a() != null) {
                ...
                if (a.a) {
                    ...
                    if (!(e == null || (intValue = e.getIntValue("SdkStatFileLimit")) == 0 || intValue >= a.f)) {
                        a.e = intValue;
                        a.g = intValue + 1024;
                    }
                ...
                if (lowerCase.startsWith("http://") || lowerCase.startsWith("https://")) {
                    ...
                    a2.a("sum_pv");
                    if (SDKFactory.b() && 2 == SDKFactory.d()) {
                        a2.a("sum_swv_pv");
                        return;
                    }
                    return;
                ...
                if (a.a() != null) {
                    ...
                    if (a.c()) {
                        ...
                        synchronized (a2.i) {
                            ...
                            a.a((Map<String, String>) (Map) pair.second);
        ...
        public static void upload() {
            if (a.a() != null) {
                a a2 = a.a();
                if (a.c() && !b.a((String) UCCore.getGlobalOption(UCCore.PROCESS_PRIVATE_DATA_DIR_SUFFIX_OPTION))) {
