...
public class UCMRunningInfo {
    ...
    public final br ucmPackageInfo;

    public UCMRunningInfo(Context context, br brVar, ClassLoader classLoader2, ClassLoader classLoader3, boolean z, boolean z2, UCMobileWebKit uCMobileWebKit, int i, boolean z3, int i2) {
        this.appCtx = context.getApplicationContext();
        this.ucmPackageInfo = brVar;
