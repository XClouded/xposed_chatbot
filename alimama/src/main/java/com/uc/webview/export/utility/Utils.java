...
public class Utils {
    ...
    public static boolean checkSupportSamplerExternalOES() {
        ...
        try {
            ...
            if (egl10.eglGetCurrentContext() == EGL10.EGL_NO_CONTEXT) {
                ...
                if (glGetString != null && glGetString.toLowerCase().contains("google") && glGetString2 != null && glGetString2.toLowerCase().contains("emulator")) {
                    return true;
                }
            ...
            if (str != null && str.contains("GL_OES_EGL_image_external")) {
                return true;
            }
    ...
    protected static void setProxyAddress(String str) {
        ...
        if (e != null) {
            e.setStringValue("FoxyServerAddr", str);
            e.setStringValue("WifiFoxyServerAddr", str);
        }
    }
}
