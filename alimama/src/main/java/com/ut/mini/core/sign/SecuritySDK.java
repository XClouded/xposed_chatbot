...
class SecuritySDK {
        ...
        if (this.mAppkey == null) {
            ...
            if (this.s_securityGuardManagerObj == null || this.s_securityGuardParamContextClz == null || this.s_securityGuardParamContext_appKey == null || this.s_securityGuardParamContext_paramMap == null || this.s_securityGuardParamContext_requestType == null || this.s_signRequestMethod == null || this.s_secureSignatureCompObj == null) {
                ...
                try {
                    ...
                    str2 = (String) this.s_signRequestMethod.invoke(this.s_secureSignatureCompObj, new Object[]{newInstance, this.mAuthcode});
                } catch (Exception e) {
    ...
    private synchronized void initSecurityCheck() {
        /*
            r9 = this;
            monitor-enter(r9)
            boolean r0 = r9.isInitSecurityCheck     // Catch:{ all -> 0x00a8 }
        ...
        L_0x0048:
            ...
            com.alibaba.analytics.utils.Logger.w((java.lang.String) r5, (java.lang.Object[]) r6)     // Catch:{ all -> 0x00a8 }
        L_0x0055:
        ...
        L_0x0096:
            ...
            com.alibaba.analytics.utils.Logger.w((java.lang.String) r4, (java.lang.Object[]) r1)     // Catch:{ all -> 0x00a8 }
        L_0x00a4:
            r9.isInitSecurityCheck = r2     // Catch:{ all -> 0x00a8 }
            monitor-exit(r9)
            return
        L_0x00a8:
            r0 = move-exception
