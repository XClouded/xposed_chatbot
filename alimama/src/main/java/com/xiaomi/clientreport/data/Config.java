...
public class Config {
    ...
    private Config(Context context, Builder builder) {
        ...
        this.mAESKey = !TextUtils.isEmpty(builder.mAESKey) ? builder.mAESKey : be.a(context);
    ...
    public static Config defaultConfig(Context context) {
        return getBuilder().setEventEncrypted(true).setAESKey(be.a(context)).setMaxFileLength(1048576).setEventUploadSwitchOpen(false).setEventUploadFrequency(86400).setPerfUploadSwitchOpen(false).setPerfUploadFrequency(86400).build(context);
    }
