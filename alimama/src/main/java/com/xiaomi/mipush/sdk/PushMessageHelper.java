...
public class PushMessageHelper {
    ...
    public static MiPushMessage generateMessage(ij ijVar, ht htVar, boolean z) {
        ...
        miPushMessage.setMessageId(ijVar.a());
