...
public class ay {
    ...
    public static java.lang.String a(java.util.Iterator<?> r3, java.lang.String r4) {
        ...
        L_0x003a:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.ay.a(java.util.Iterator, java.lang.String):java.lang.String");
    }
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static byte[] m98a(String str) {
        try {
    ...
    public static boolean m99b(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
