...
public enum hl {
    ...
    StatDataUploadNum(SecExceptionCode.SEC_ERROR_INIT_DATA_FILE_MISMATCH),
    StatDataProcessFrequency(SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE),
    StatDataSwitch(SecExceptionCode.SEC_ERROR_INIT_INCORRECT_DATA_FILE),
    StatDataUploadWay(SecExceptionCode.SEC_ERROR_INIT_LOW_VERSION_DATA),
