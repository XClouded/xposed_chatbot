...
public final class ULongArrayKt {
    ...
    private static final long[] m855ulongArrayOfQwZRm1k(long... jArr) {
        return jArr;
    }
    ...
    private static final long[] ULongArray(int i, Function1<? super Integer, ULong> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            jArr[i2] = function1.invoke(Integer.valueOf(i2)).m837unboximpl();
        }
        return ULongArray.m840constructorimpl(jArr);
    }
}
