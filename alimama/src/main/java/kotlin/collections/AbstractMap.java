...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(entrySet(), AVFSCacheConstants.COMMA_SEP, Operators.BLOCK_START_STR, "}", 0, (CharSequence) null, new AbstractMap$toString$1(this), 24, (Object) null);
    }

    /* access modifiers changed from: private */
    public final String toString(Map.Entry<? extends K, ? extends V> entry) {
        return toString((Object) entry.getKey()) + SymbolExpUtil.SYMBOL_EQUAL + toString((Object) entry.getValue());
    }
