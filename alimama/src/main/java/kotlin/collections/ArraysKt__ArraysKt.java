                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m1038contentEqualsus8wMrg(((ULongArray) t).m854unboximpl(), ((ULongArray) t2).m854unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m1035contentEqualsctEhBpI(((UIntArray) t).m785unboximpl(), ((UIntArray) t2).m785unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m1037contentEqualsmazbYpA(((UShortArray) t).m949unboximpl(), ((UShortArray) t2).m949unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m1036contentEqualskdPth3s(((UByteArray) t).m716unboximpl(), ((UByteArray) t2).m716unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(@NotNull T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m1044contentToStringGBYM_sE(((UByteArray) t).m716unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m1046contentToStringrL5Bavg(((UShortArray) t).m949unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m1043contentToStringajY9A(((UIntArray) t).m785unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m1045contentToStringQwZRm1k(((ULongArray) t).m854unboximpl()));
            } else {
