...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m987containsWZ4Q5Ns(((UInt) obj).m768unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m988indexOfWZ4Q5Ns(((UInt) obj).m768unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m989lastIndexOfWZ4Q5Ns(((UInt) obj).m768unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UIntArray.m777getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UIntArray.m779isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m987containsWZ4Q5Ns(int i) {
        return UIntArray.m772containsWZ4Q5Ns(this.$this_asList, i);
    }

    @NotNull
    public UInt get(int i) {
        return UInt.m719boximpl(UIntArray.m776getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-WZ4Q5Ns  reason: not valid java name */
    public int m988indexOfWZ4Q5Ns(int i) {
        return ArraysKt.indexOf(this.$this_asList, i);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns  reason: not valid java name */
    public int m989lastIndexOfWZ4Q5Ns(int i) {
