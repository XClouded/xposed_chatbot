...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m990containsVKZWuLQ(((ULong) obj).m837unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m991indexOfVKZWuLQ(((ULong) obj).m837unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m992lastIndexOfVKZWuLQ(((ULong) obj).m837unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return ULongArray.m846getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return ULongArray.m848isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m990containsVKZWuLQ(long j) {
        return ULongArray.m841containsVKZWuLQ(this.$this_asList, j);
    }

    @NotNull
    public ULong get(int i) {
        return ULong.m788boximpl(ULongArray.m845getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-VKZWuLQ  reason: not valid java name */
    public int m991indexOfVKZWuLQ(long j) {
        return ArraysKt.indexOf(this.$this_asList, j);
    }

    /* renamed from: lastIndexOf-VKZWuLQ  reason: not valid java name */
    public int m992lastIndexOfVKZWuLQ(long j) {
