...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m993contains7apg3OU(((UByte) obj).m699unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UByte) {
            return m994indexOf7apg3OU(((UByte) obj).m699unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UByte) {
            return m995lastIndexOf7apg3OU(((UByte) obj).m699unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UByteArray.m708getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UByteArray.m710isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-7apg3OU  reason: not valid java name */
    public boolean m993contains7apg3OU(byte b) {
        return UByteArray.m703contains7apg3OU(this.$this_asList, b);
    }

    @NotNull
    public UByte get(int i) {
        return UByte.m652boximpl(UByteArray.m707getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-7apg3OU  reason: not valid java name */
    public int m994indexOf7apg3OU(byte b) {
        return ArraysKt.indexOf(this.$this_asList, b);
    }

    /* renamed from: lastIndexOf-7apg3OU  reason: not valid java name */
    public int m995lastIndexOf7apg3OU(byte b) {
