...
public final class FilePathComponents {
    ...
    public final FilePathComponents copy(@NotNull File file, @NotNull List<? extends File> list) {
        Intrinsics.checkParameterIsNotNull(file, ProtocolConst.KEY_ROOT);
    ...
    public String toString() {
        return "FilePathComponents(root=" + this.root + ", segments=" + this.segments + Operators.BRACKET_END_STR;
    }
