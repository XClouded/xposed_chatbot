...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String getInvariantSeparatorsPath(@NotNull File file) {
        ...
        if (File.separatorChar != '/') {
            ...
            return StringsKt.replace$default(path, File.separatorChar, (char) DXTemplateNamePathUtil.DIR, false, 4, (Object) null);
        }
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(@NotNull File file, File file2) {
        ...
        if (i < size2) {
            ...
            CollectionsKt.joinTo$default(CollectionsKt.drop(normalize$FilesKt__UtilsKt.getSegments(), i), sb, str, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, SecExceptionCode.SEC_ERROR_INIT_LOW_VERSION_DATA, (Object) null);
        }
        return sb.toString();
    }
    ...
    public static final File copyTo(@NotNull File file, @NotNull File file2, boolean z, int i) {
        ...
        Intrinsics.checkParameterIsNotNull(file2, Constants.KEY_TARGET);
        if (file.exists()) {
            if (file2.exists()) {
                boolean z2 = true;
                if (z && file2.delete()) {
    ...
    public static final boolean copyRecursively(@org.jetbrains.annotations.NotNull java.io.File r11, @org.jetbrains.annotations.NotNull java.io.File r12, boolean r13, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super java.io.File, ? super java.io.IOException, ? extends kotlin.io.OnErrorAction> r14) {
        ...
        L_0x002f:
            return r1
        L_0x0030:
            kotlin.io.FileTreeWalk r0 = kotlin.io.FilesKt.walkTopDown(r11)     // Catch:{ TerminateException -> 0x00e7 }
        ...
        L_0x0043:
            ...
            return r2
        L_0x006c:
            java.lang.String r4 = kotlin.io.FilesKt.toRelativeString(r3, r11)     // Catch:{ TerminateException -> 0x00e7 }
        ...
        L_0x008b:
            ...
            boolean r4 = kotlin.io.FilesKt.deleteRecursively(r5)     // Catch:{ TerminateException -> 0x00e7 }
        ...
        L_0x00bf:
            ...
            r4 = r3
            r6 = r13
            java.io.File r4 = kotlin.io.FilesKt.copyTo$default(r4, r5, r6, r7, r8, r9)     // Catch:{ TerminateException -> 0x00e7 }
