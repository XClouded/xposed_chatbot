...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(long j) {
        long j2 = (long) UCCore.SPEEDUP_DEXOPT_POLICY_DAVIK;
        if (((long) -128) <= j && j2 >= j) {
    ...
    public static final Byte toByteExactOrNull(short s) {
        short s2 = (short) -128;
        short s3 = (short) UCCore.SPEEDUP_DEXOPT_POLICY_DAVIK;
        if (s2 <= s && s3 >= s) {
    ...
    public static final Byte toByteExactOrNull(double d) {
        double d2 = (double) UCCore.SPEEDUP_DEXOPT_POLICY_DAVIK;
    ...
    public static final Byte toByteExactOrNull(float f) {
        float f2 = (float) UCCore.SPEEDUP_DEXOPT_POLICY_DAVIK;
        if (f < ((float) -128) || f > f2) {
            return null;
        }
