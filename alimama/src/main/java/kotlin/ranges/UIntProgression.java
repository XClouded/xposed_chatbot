...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        if (i3 == 0) {
            ...
            this.first = i;
            this.last = UProgressionUtilKt.m1482getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
        } else {
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m762toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m762toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1496fromClosedRangeNkh28Cs(int i, int i2, int i3) {
