...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1497containsWZ4Q5Ns(((UInt) comparable).m768unboximpl());
    }

    @NotNull
    public UInt getStart() {
        return UInt.m719boximpl(getFirst());
    }

    @NotNull
    public UInt getEndInclusive() {
        return UInt.m719boximpl(getLast());
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m1497containsWZ4Q5Ns(int i) {
    ...
    public String toString() {
        return UInt.m762toStringimpl(getFirst()) + ".." + UInt.m762toStringimpl(getLast());
    }
