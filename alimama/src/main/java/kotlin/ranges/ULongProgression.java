...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1481getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public int hashCode() {
        ...
        return (((((int) ULong.m794constructorimpl(this.first ^ ULong.m794constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m794constructorimpl(this.last ^ ULong.m794constructorimpl(this.last >>> 32)))) * 31) + ((int) (this.step ^ (this.step >>> 32)));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m831toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m831toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1498fromClosedRange7ftBX0g(long j, long j2, long j3) {
