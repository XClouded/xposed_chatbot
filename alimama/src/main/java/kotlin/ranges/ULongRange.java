...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1499containsVKZWuLQ(((ULong) comparable).m837unboximpl());
    }

    @NotNull
    public ULong getStart() {
        return ULong.m788boximpl(getFirst());
    }

    @NotNull
    public ULong getEndInclusive() {
        return ULong.m788boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m1499containsVKZWuLQ(long j) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m794constructorimpl(getFirst() ^ ULong.m794constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m794constructorimpl(getLast() ^ ULong.m794constructorimpl(getLast() >>> 32)));
    }

    @NotNull
    public String toString() {
        return ULong.m831toStringimpl(getFirst()) + ".." + ULong.m831toStringimpl(getLast());
    }
