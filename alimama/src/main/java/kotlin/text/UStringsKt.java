...
public final class UStringsKt {
    ...
    public static final String m1535toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1537toStringolVBNx4(short s, int i) {
    ...
    public static final String m1536toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1534toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(@NotNull String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m699unboximpl();
        }
    ...
    public static final short toUShort(@NotNull String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m932unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final int toUInt(@NotNull String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m768unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final long toULong(@NotNull String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m837unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final UByte toUByteOrNull(@NotNull String str, int i) {
        ...
        int r1 = uIntOrNull.m768unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m725constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m652boximpl(UByte.m658constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(@NotNull String str, int i) {
        ...
        int r1 = uIntOrNull.m768unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m725constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m885boximpl(UShort.m891constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(@NotNull String str, int i) {
        ...
        int r4 = UInt.m725constructorimpl(i);
        int r2 = UnsignedKt.m951uintDivideJ1ME1BU(-1, r4);
        while (i3 < length) {
            int digitOf = CharsKt.digitOf(str.charAt(i3), i);
            if (digitOf < 0 || UnsignedKt.uintCompare(i2, r2) > 0) {
                return null;
            }
            int r3 = UInt.m725constructorimpl(i2 * r4);
            int r5 = UInt.m725constructorimpl(UInt.m725constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(@NotNull String str, int i) {
        ...
        long r5 = ((long) UInt.m725constructorimpl(i)) & 4294967295L;
        long r2 = UnsignedKt.m953ulongDivideeb3DHEI(-1, ULong.m794constructorimpl(r5));
        long j = 0;
        while (i2 < length) {
            ...
            long r9 = ULong.m794constructorimpl(j * ULong.m794constructorimpl(r5));
            long r11 = ULong.m794constructorimpl(ULong.m794constructorimpl(((long) UInt.m725constructorimpl(digitOf)) & 4294967295L) + r9);
