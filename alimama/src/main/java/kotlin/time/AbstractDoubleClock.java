...
public abstract class AbstractDoubleClock implements Clock {
    ...
    private static final class DoubleClockMark extends ClockMark {
        ...
        public double elapsedNow() {
            return Duration.m1568minusLRDsOJo(DurationKt.toDuration(this.clock.read() - this.startedAt, this.clock.getUnit()), this.offset);
        }

        @NotNull
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ClockMark m1538plusLRDsOJo(double d) {
            return new DoubleClockMark(this.startedAt, this.clock, Duration.m1569plusLRDsOJo(this.offset, d), (DefaultConstructorMarker) null);
        }
    }
