...
public abstract class AbstractLongClock implements Clock {
    ...
    private static final class LongClockMark extends ClockMark {
        ...
        public ClockMark m1539plusLRDsOJo(double d) {
            return new LongClockMark(this.startedAt, this.clock, Duration.m1569plusLRDsOJo(this.offset, d), (DefaultConstructorMarker) null);
        }
    }
