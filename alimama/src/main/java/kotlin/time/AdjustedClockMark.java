...
final class AdjustedClockMark extends ClockMark {
    ...
    public double elapsedNow() {
        return Duration.m1568minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    @NotNull
    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public ClockMark m1540plusLRDsOJo(double d) {
        return new AdjustedClockMark(this.mark, Duration.m1569plusLRDsOJo(this.adjustment, d), (DefaultConstructorMarker) null);
    }
}
