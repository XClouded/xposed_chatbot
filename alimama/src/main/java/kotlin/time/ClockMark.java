...
public abstract class ClockMark {
    ...
    public ClockMark m1542plusLRDsOJo(double d) {
        return new AdjustedClockMark(this, d, (DefaultConstructorMarker) null);
    }

    @NotNull
    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public ClockMark m1541minusLRDsOJo(double d) {
        return m1542plusLRDsOJo(Duration.m1586unaryMinusimpl(d));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1566isNegativeimpl(elapsedNow());
    }
