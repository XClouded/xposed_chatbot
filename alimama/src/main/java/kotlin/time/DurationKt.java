...
public final class DurationKt {
    ...
    private static final double m1590timesmvk6XK0(int i, double d) {
        return Duration.m1572timesimpl(d, i);
    }
    ...
    private static final double m1589timeskIfJnKk(double d, double d2) {
        return Duration.m1571timesimpl(d2, d);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m1545constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
