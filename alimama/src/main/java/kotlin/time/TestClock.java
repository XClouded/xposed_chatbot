...
public final class TestClock extends AbstractLongClock {
    ...
    public final void m1592plusAssignLRDsOJo(double d) {
        long j;
        double r0 = Duration.m1577toDoubleimpl(d, getUnit());
        long j2 = (long) r0;
    ...
    private final void m1591overflowLRDsOJo(double d) {
        throw new IllegalStateException("TestClock will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m1583toStringimpl(d) + '.');
    }
}
