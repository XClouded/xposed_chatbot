...
public class ErrorConstant {
    ...
    public static boolean isNetworkError(String str) {
        return "ANDROID_SYS_NETWORK_ERROR".equals(str) || ERRCODE_NO_NETWORK.equals(str);
    }
    ...
    public static boolean isSessionInvalid(String str) {
        return ERRCODE_FAIL_SYS_SESSION_EXPIRED.equals(str) || ERRCODE_ANDROID_SYS_LOGIN_FAIL.equals(str);
    }
