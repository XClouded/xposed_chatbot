...
public class QuicProofVerifier {
    ...
    public static int VerifyProof(String str, int i, String str2, int i2, String str3, String[] strArr, String str4, String str5) {
        ...
        while (true) {
            if (i4 >= length) {
                break;
            } else if (getCNfromSubject(split[i4], sb)) {
                break;
            } else {
                i4++;
            }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:14:0x0040 A[ExcHandler: InvalidAlgorithmParameterException (r1v7 'e' java.security.InvalidAlgorithmParameterException A[CUSTOM_DECLARE]), Splitter:B:5:0x000b] */
    ...
    private static int verifySignature(java.lang.String r10, int r11, java.lang.String r12, java.security.cert.X509Certificate r13, java.lang.String r14) {
        /*
            ...
            r0 = 0
            java.lang.String r1 = r13.getAlgorithm()     // Catch:{ NoSuchAlgorithmException -> 0x0045, InvalidAlgorithmParameterException -> 0x0040 }
            java.lang.String r2 = "RSA"
            boolean r1 = r1.contains(r2)     // Catch:{ NoSuchAlgorithmException -> 0x0045, InvalidAlgorithmParameterException -> 0x0040 }
            if (r1 == 0) goto L_0x0037
            java.lang.String r1 = "SHA256withRSA/PSS"
            java.security.Signature r1 = java.security.Signature.getInstance(r1)     // Catch:{ NoSuchAlgorithmException -> 0x0045, InvalidAlgorithmParameterException -> 0x0040 }
        ...
        L_0x004d:
            ...
            r0.initVerify(r13)     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            ...
            byte[] r13 = r13.getBytes(r1)     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            r0.update(r13)     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            r13 = 4
            byte[] r13 = new byte[r13]     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            int r1 = r12.length()     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            byte r1 = (byte) r1     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            r13[r11] = r1     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            r0.update(r13)     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            ...
            r0.update(r12)     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            ...
            r0.update(r10)     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
            ...
            boolean r10 = r0.verify(r10)     // Catch:{ InvalidKeyException -> 0x0094, SignatureException -> 0x008f, UnsupportedEncodingException -> 0x008a }
