...
public class SecurityGuardCacherImp implements QuicCacher {
    ...
    public synchronized void init(Context context) {
        if (!this.init_ok) {
            try {
                ...
                this.sgMgr = this.getInstance.invoke((Object) null, new Object[]{context});
                if (this.sgMgr != null) {
    ...
    public boolean store(String str, String str2) {
        if (this.init_ok) {
            try {
                this.putStringDDpEx.invoke(this.ddsComp, new Object[]{str, str2, 0});
                return true;
    ...
    public byte[] load(String str) {
        ...
        try {
            String str2 = (String) this.getStringDDpEx.invoke(this.ddsComp, new Object[]{str, 0});
            if (str2 != null) {
